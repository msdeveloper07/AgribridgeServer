...
class Organizations extends Migration
{
    ...
    public function up()
    {
        Schema::create('organizations', function (Blueprint $table) {
            ...
            $table->string('org_code', 45)->nullable()->comment('Organization Code is used as a subdomain of website. This should not have any special characters to it. Only upto 10 char text.');
            $table->string('org_name', 45)->nullable();
